...
<div class="form-container">
    <form action="{{ route('annonce.update') }}" method="POST" enctype="multipart/form-data" class="creation-form">        @csrf
        <input type="hidden" name="id" value="{{ $annonce->id }}">
        <div class="form-group">
            <label for="titre" class="form-label">Titre</label>
            <input type="text" id="titre" name="titre" class="form-input" value="{{ $annonce->titre }}" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" id="prix" name="prix" class="form-input" value="{{ $annonce->prix }}" step="0.01" required>
        </div>
        <button type="submit" class="form-button">Mettre à jour l'annonce</button>
    </form>
